...
public class MonitoringRecord implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MonitoringRecord that = (MonitoringRecord) o;
        return Double.compare(that.prediction, prediction) == 0 &&
                Double.compare(that.error, error) == 0 &&
                Double.compare(that.anomaly, anomaly) == 0 &&
                Double.compare(that.predictionNext, predictionNext) == 0 &&
                Objects.equals(stateCode, that.stateCode) &&
                Objects.equals(countyCode, that.countyCode) &&
                Objects.equals(siteNum, that.siteNum) &&
                ...
                Objects.equals(dateLocal, that.dateLocal) &&
                Objects.equals(timeLocal, that.timeLocal) &&
                Objects.equals(dateGMT, that.dateGMT) &&
                Objects.equals(timeGMT, that.timeGMT) &&
                Objects.equals(sampleMeasurement, that.sampleMeasurement) &&
                Objects.equals(unitsOfMeasure, that.unitsOfMeasure) &&
                Objects.equals(mdl, that.mdl) &&
                ...
                Objects.equals(dateOfLastChange, that.dateOfLastChange);
    }

    @Override
    public int hashCode() {

        return Objects.hash(stateCode, countyCode, siteNum, parameterCode, poc, latitude, longitude, datum, parameterName, dateLocal, timeLocal, dateGMT, timeGMT, sampleMeasurement, unitsOfMeasure, mdl, uncertainty, qualifier, methodType, methodCode, methodName, stateName, countyName, dateOfLastChange, prediction, error, anomaly, predictionNext);
    }
